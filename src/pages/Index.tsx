    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-4 mt-6">
          <Card className="hover:shadow-md transition-shadow"><CardHeader><CardTitle className="text-sm flex items-center gap-2"><TrendingUp className="w-4 h-4 text-violet-600"/> Growth analyst</CardTitle></CardHeader><CardContent className="text-xs text-muted-foreground">Ask “What’s driving activation?” → group-by + correlation + regression, all verified, export stamped report to Slack. No more spreadsheet joins.</CardContent></Card>
